...
class GumbelQuantize(nn.Module):
    ...
    Gumble max generates a different prbability vector for summing each time a sample goes through, with a low tau
    producing sharp distribution, this actually simulates sampling from softmax
